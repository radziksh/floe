...
b4w.register("icebearg", function(exports, require) {
    ...
    function load() {
        m_data.load("../../deploy/assets/icebearg/icebearg.json", load_cb);
    }
    ...
    function load_cb(data_id) {
        ...
        var pinqui_player = m_scs.get_object_by_name("pinquiplayer");
        debugger;
        m_cons.append_track(pinqui_player, character);
        m_cons.append_stiff_trans(camobj, character, [0, 0.7, -2]);
